...
import { getAppointments, getCollaborators } from "@/actions/appointments/getMany";
...
export default async function AppointmentsPage({ searchParams }: AppointmentsPageProps) {
  ...
  const appointments = appointmentsResult.success ? appointmentsResult.data!.appointments : [];
