    ...
    <section>
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-muted-foreground">{BENEFITS_TEXTS.subtitle}</p>
        </div>
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="flex gap-x-4">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">{BENEFITS_TEXTS.benefits[0].description}</p>
            </div>
          </div>
          <div className="flex gap-x-4">
            <div className="flex-none">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">{BENEFITS_TEXTS.benefits[1].description}</p>
            </div>
          </div>
          <div className="flex gap-x-4">
            <div className="flex-none">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">{BENEFITS_TEXTS.benefits[2].description}</p>
            </div>
          </div>
          <div className="flex gap-x-4">
            <div className="flex-none">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">{BENEFITS_TEXTS.benefits[3].description}</p>
            </div>
          </div>
        </div>
      </div>
